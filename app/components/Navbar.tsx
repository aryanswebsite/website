...
const Navbar = () => {
    return (
        <div className='fixed w-screen flex justify-center z-20'>
            <div className='absolute rounded-full bg-mclaren-orange drop-shadow-md-strong font-work-sans top-5 px-6 py-3'>
